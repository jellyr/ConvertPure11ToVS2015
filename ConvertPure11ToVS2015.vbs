...
' Project name.
name			= "YourOwnProjectName"

filterName = objFSO.BuildPath(objFSO.GetFolder(".").Path, root) 
...
"<Project DefaultTargets=""Build"" ToolsVersion=""14.0"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">" & vbCrLf & _
...
"        <ConfigurationType>Application</ConfigurationType>" & vbCrLf & _
"        <PlatformToolset>v140</PlatformToolset>" & vbCrLf & _
"    </PropertyGroup>" & vbCrLf & _
...
"    <ClCompile>" & vbCrLf & _
"    <AdditionalIncludeDirectories>./</AdditionalIncludeDirectories>" & vbCrLf & _
"    </ClCompile>" & vbCrLf & _
"    </ItemDefinitionGroup>" & vbCrLf & _
...
Sub ScanInterestingFiles(Folder)
    ...
    For Each objFile in colFiles
		...
		If (InStr(objFile.Name, ".") > 0) Then
			...
			Then
				...
				hMap.Add Replace(objFile.Path, filterName, ""), Replace(Folder.Path, filterName, "")
			End If
			...
			ext = ".asm" _
			Then
				sMap.Add Replace(objFile.Path, filterName, ""), Replace(Folder.Path, filterName, "")
			End If
	...
	f = Replace(Folder.Path, filterName, "")
